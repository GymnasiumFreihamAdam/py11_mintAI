pairs = [
    [r"(?i)guten morgen(.*)", ["Guten Morgen! Wie kann ich Ihnen heute helfen?",]],
    [r"(?i)guten abend(.*)", ["Guten Abend! Wie war Ihr Tag?",]],
    [r"(?i)ersteller(.*)", ["Dies ist ein Projekt des Gymnasium Freihams. Code: Adam Basly. Grafik, Design & Co.: Jonas",]],
    [r"(?i)maker(.*)", ["Dies ist ein Projekt des Gymnasium Freihams. Code: Adam Basly. Grafik, Design & Co.: Jonas",]],
